...
GameOverState::GameOverState(PlayerColor color)
{
	...
	if (color == White)
	{
		mMenuItems.push_back(new TextLabel(160, 70, 300, 30, L"White is the Winner", 45, Color(0, 0, 0, 0), -1));
	}
	else
	{
		mMenuItems.push_back(new TextLabel(160, 70, 300, 30, L"Black is the Winner", 45, Color(0, 0, 0, 0), -1));
	}
