...
PickState::PickState()
{
	...
	mMenuItems.push_back(mStartButton = new Button(300, 350, 200, 30, L"Start Game", 15, Color(255, 100, 100, 200), 1));
	mMenuItems.push_back(mMenuButton = new Button(300, 400, 200, 30, L"Main Menu", 15, Color(255, 100, 100, 200), 1));
