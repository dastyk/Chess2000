...
MainMenu::MainMenu()
{
	...
	mMenuItems.push_back(mPlayButton = new Button(300, 350, 200, 30, L"Play Game", 15, Color(200, 100, 100, 200), 1));
	mMenuItems.push_back(mExitButton = new Button(300, 400, 200, 30, L"Exit Game", 15, Color(200, 100, 100, 200), 1));
